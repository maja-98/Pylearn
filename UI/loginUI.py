...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pylearn.setGeometry(QtCore.QRect(270, 170, 70, 13))
        self.pylearn.setObjectName("pylearn")
        #self.pylearn.setFont(QtGui.QFont('Calibri Light', 10))
        
        self.username_lbl = QtWidgets.QLabel(self.centralwidget)
        self.username_lbl.setGeometry(QtCore.QRect(210, 240, 47, 13))
        self.username_lbl.setObjectName("username_lbl")
        self.password_lbl = QtWidgets.QLabel(self.centralwidget)
        self.password_lbl.setGeometry(QtCore.QRect(210, 270, 47, 13))
        ...
        self.label.setGeometry(QtCore.QRect(280, 210, 31, 16))
